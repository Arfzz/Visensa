...
import visensaLogo from "../../assets/visensa-logo.png"; // Pastikan path ini benar
...
const patientsData = [
  { id: "RJ", name: "Robert Johnson", week: "Wk 4", active: true, color: "#0099A6" },
  { id: "ML", name: "Margaret Lim", week: "Wk 2", active: false, color: "#D4A843" },
  { id: "AK", name: "Ahmad Kusuma", week: "Wk 7", active: false, color: "#4BA882" },
  { id: "DS", name: "Diana Santoso", week: "Wk 1", active: false, color: "#0099A6" },
];
...
const movementStats = [
  { label: "Joint accuracy", val: "97%", sub: "latest session", color: "#3ED8C8" },
  { label: "Avg range score", val: "82%", sub: "exercises done", color: "#0099A6" },
...
const Dashboard = () => {
  ...
  return (
    // width diubah jadi 100% untuk menghindari horizontal scroll issue
    <div style={{ width: "100%", height: "100vh", display: "flex", background: "#F0F2F5", fontFamily: "Space Grotesk, sans-serif", overflow: "hidden", padding: "24px", boxSizing: "border-box", gap: "32px" }}>
      ...
      <div style={{ width: "320px", minWidth: "320px", background: "#151E2C", borderRadius: "24px", boxShadow: "0px 13px 80px rgba(226, 236, 249, 0.25)", display: "flex", flexDirection: "column", zIndex: 10, overflow: "hidden" }}>
        ...
        <div style={{ height: "1px", background: "rgba(255, 255, 255, 0.10)", margin: "0 30px" }} />

        {/* Patients List */}
        <div style={{ flex: 1, padding: "20px 30px", overflowY: "auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <div style={{ color: "#7AAAB4", fontSize: "11px", fontFamily: "Space Mono", letterSpacing: "1.2px" }}>PATIENTS (4)</div>
            ...
            <div style={{ width: "28px", height: "28px", background: "rgba(96.85, 242.61, 255, 0.08)", borderRadius: "8px", display: "flex", justifyContent: "center", alignItems: "center", cursor: "pointer" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {patientsData.map((patient) => (
              <div key={patient.id} style={{ padding: "12px 16px", background: patient.active ? "#F0FAFB" : "transparent", borderRadius: "12px", border: patient.active ? "1px solid #C4E8EC" : "1px solid transparent", display: "flex", alignItems: "center", gap: "12px", cursor: "pointer", transition: "all 0.2s" }}>
                <div style={{ width: "36px", height: "36px", background: patient.active ? "linear-gradient(135deg, #0099A6 0%, #007580 100%)" : "#1A2536", borderRadius: "50%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                  <span style={{ color: patient.active ? "white" : "#7AAAB4", fontSize: "13px", fontWeight: "700" }}>{patient.id}</span>
                </div>
                <div>
                  <div style={{ color: patient.active ? "#151E2C" : "#F0FAFB", fontSize: "14.5px", fontWeight: patient.active ? "700" : "500", marginBottom: "2px" }}>{patient.name}</div>
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    <div style={{ width: "8px", height: "8px", background: patient.color, borderRadius: "50%", boxShadow: patient.id === "ML" ? "0 0 0 3px rgba(212,168,67,0.2)" : "none" }} />
        ...
        <div style={{ padding: "30px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", background: "#F0FAFB", padding: "12px", borderRadius: "16px" }}>
            <div style={{ width: "36px", height: "36px", background: "linear-gradient(135deg, #0099A6 0%, #007580 100%)", borderRadius: "50%", display: "flex", justifyContent: "center", alignItems: "center" }}>
              <span style={{ color: "white", fontSize: "13px", fontWeight: "700" }}>SK</span>
            </div>
            <div>
              <div style={{ color: "#0C2830", fontSize: "14.5px", fontWeight: "700" }}>Dr. Sarah K.</div>
      ...
      {/* MAIN CONTENT (KANAN)           */}
      {/* ============================== */}
      <div style={{ flex: 1, overflowY: "auto", paddingRight: "12px", paddingBottom: "24px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "40px", marginTop: "16px" }}>
          ...
          <div style={{ position: "relative" }}>
            <div 
              ...
              style={{ width: "48px", height: "48px", background: "white", borderRadius: "16px", boxShadow: "0px 2px 10px rgba(0,0,0,0.05)", display: "flex", justifyContent: "center", alignItems: "center", cursor: "pointer", border: showNotif ? "1.5px solid #0099A6" : "1.5px solid transparent", transition: "all 0.2s" }}
            >
            ...
            {/* Dropdown Notifikasi */}
            {showNotif && (
              <div style={{ position: 'absolute', top: '60px', right: '0', width: '450px', background: 'white', boxShadow: '0px 12px 50px rgba(12, 40, 48, 0.15)', borderRadius: '24px', border: '1.5px solid #C4E8EC', zIndex: 100, overflow: 'hidden' }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px" }}>
          <div style={{ display: "flex", gap: "20px", alignItems: "center" }}>
            <div style={{ width: "56px", height: "56px", background: "linear-gradient(135deg, #0099A6 0%, #007580 100%)", borderRadius: "50%", display: "flex", justifyContent: "center", alignItems: "center", boxShadow: "0px 4px 15px rgba(0, 153, 166, 0.2)" }}>
              <span style={{ color: "white", fontSize: "20px", fontWeight: "700" }}>RJ</span>
            </div>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
                <div style={{ color: "#0C2830", fontSize: "24px", fontWeight: "700" }}>Robert Johnson</div>
              ...
              <div style={{ display: "flex", gap: "20px", color: "#7AAAB4", fontSize: "14.5px", fontFamily: "Space Mono" }}>
                <span>Phantom Limb Pain</span>
                <span>Week 4</span>
                <span>87% compliance</span>
                <span>Pain: 4/10</span>
              </div>
            </div>
          </div>
          ...
          {/* Navigasi Tab */}
          <div style={{ display: "flex", background: "white", padding: "6px", borderRadius: "16px", border: "1px solid #C4E8EC", boxShadow: "0px 2px 10px rgba(0,0,0,0.02)" }}>
            ...
            <button onClick={() => setActiveTab("Movement")} style={{ padding: "10px 20px", background: activeTab === "Movement" ? "#F0FAFB" : "transparent", border: activeTab === "Movement" ? "1px solid #C4E8EC" : "1px solid transparent", borderRadius: "12px", color: activeTab === "Movement" ? "#0099A6" : "#7AAAB4", fontSize: "15px", fontWeight: activeTab === "Movement" ? "700" : "500", cursor: "pointer", display: "flex", alignItems: "center", gap: "8px", transition: "all 0.2s" }}>
        ...
        {activeTab === "Feedback" ? (
          ...
          <>
            ...
            <div style={{ display: "flex", gap: "12px", marginBottom: "30px" }}>
              {dateTabs.map((date, i) => (
                <div key={i} style={{ padding: "8px 20px", background: i === 0 ? "rgba(0, 153, 166, 0.08)" : "white", borderRadius: "20px", border: i === 0 ? "1.5px solid #0099A6" : "1.5px solid #C4E8EC", color: i === 0 ? "#0099A6" : "#7AAAB4", fontSize: "14.5px", fontFamily: "Space Mono", fontWeight: i === 0 ? "700" : "400", cursor: "pointer" }}>
                  {date}
                </div>
              ))}
            </div>

            {/* List Movement dengan Penyesuaian FlexShrink & MinWidth */}
            <div style={{ background: "white", borderRadius: "20px", border: "1px solid #C4E8EC", boxShadow: "0 4px 15px rgba(0,0,0,0.02)", overflow: "hidden" }}>
              ...
              <div>
                {exercisesData.map((ex, i) => (
                  <div key={i} style={{ padding: "18px 30px", borderBottom: "1px solid #E2E8F0", display: "flex", alignItems: "center", gap: "20px" }}>
                    ...
                    {/* Status Pill yang sudah disempurnakan (Anti-Gepeng) */}
