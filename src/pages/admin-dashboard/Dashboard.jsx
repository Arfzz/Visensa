...
const exercisesData = [
  ...
  { name: "Pinch grip — coin", reps: "12 reps", percent: 75, status: "Good", color: "#3ED8C8", bg: "rgba(62, 216, 200, 0.09)", stroke: "#3ED8C8", statusBg: "rgba(62, 216, 200, 0.10)" },
          ...
          <div style={{ width: "840px", background: "white", borderRadius: "35px", boxShadow: "0px 35px 106px rgba(12, 40, 48, 0.18)", border: "1.77px solid #C4E8EC", overflow: "hidden", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ padding: "35px 42px 28px", borderBottom: "1.77px solid #C4E8EC", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ display: "flex", flexDirection: "column" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "4px" }}>
                  <div style={{ width: "49px", height: "49px", background: "linear-gradient(135deg, #0099A6 0%, #007580 100%)", borderRadius: "14px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                  ...
                  <div style={{ color: "#0C2830", fontSize: "28px", fontFamily: "Space Grotesk", fontWeight: "700" }}>Register new patient</div>
                </div>
            ...
            <div style={{ padding: "35px 42px", display: "flex", flexDirection: "column", gap: "28px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                ...
                <input type="text" placeholder="e.g. Budi Santoso" style={{ width: "100%", height: "73px", padding: "0 24px", background: "white", border: "1.77px solid #C4E8EC", borderRadius: "17px", color: "#0C2830", fontSize: "22px", fontFamily: "Space Grotesk", boxSizing: "border-box", outline: "none" }} />
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                <div style={{ fontSize: "21px", fontFamily: "Space Grotesk", fontWeight: "600" }}>
                  <span style={{ color: "#3A6870" }}>Therapist note </span><span style={{ color: "#7AAAB4", fontWeight: "400" }}>(optional)</span>
                </div>
                <textarea placeholder="Initial assessment, special considerations, session frequency…" style={{ width: "100%", height: "145px", padding: "18px 24px", background: "white", border: "1.77px solid #C4E8EC", borderRadius: "17px", color: "#0C2830", fontSize: "22px", fontFamily: "Space Grotesk", boxSizing: "border-box", outline: "none", resize: "none" }} />
              </div>
            </div>
