        ...
        <div style={{ maxHeight: "350px", overflowY: "auto" }}>
          {patientNotifications.map((notif) => (
            <div
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = "rgba(0,153,166,0.04)")
              }
              onMouseLeave={(e) =>
        ...
        >
          ...
          {selectedPlanData.status === "completed" && (
            ...
            >
              ...
              session. Keep up the consistency.
            </div>
          )}
          {selectedPlanData.status === "upcoming" && (
            ...
            >
              This session is scheduled for later this week. Make sure to rest
              properly beforehand.
            </div>
          )}
        </div>
    ...
    <>
      ...
      >
        ...
        >
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isActive
                      ? "linear-gradient(135deg, #C8F135 0%, #96C000 100%)"
                      : "transparent",
                    borderRadius: "14px",
                    display: "flex",
                    alignItems: "center",
                    ...
                    cursor: "pointer",
                    boxShadow: isActive
                      ? "0px 4px 12px rgba(31, 168, 143, 0.25)"
                      : "none",
                    transition: "all 0.2s",
                    boxSizing: "border-box",
                  }}
          ...
          <div
            style={{
              background: "rgba(59, 184, 176, 0.06)",
              border: "1.5px solid rgba(59, 184, 176, 0.16)",
              borderRadius: "14px",
        ...
        {activeMenu === "Dashboard" && (
          <div
            ...
            style={{ display: "flex", flex: 1, gap: "24px", minHeight: 0 }}
          >
              ...
              >
                ...
                <div
                  style={{
                    flex: 1,
                    background:
                      "linear-gradient(135deg, #4B8BE0 0%, #2E6BC4 100%)",
                    borderRadius: "20px",
                    padding: "20px",
                    color: "white",
                    display: "flex",
                ...
                >
                  ...
                  >
                    {[0.6, 0.65, 0.75, 0.85, 0.95, 1].map((o, i) => (
                      <div
                        key={i}
                        style={{
                          flex: 1,
              ...
              >
                ...
                >
                  ...
                  {hoveredPainPoint && (
                    <div
                      style={{
                        ...
                        zIndex: 10,
                        pointerEvents: "none",
                        boxShadow: "0 8px 24px rgba(0,153,166,0.12)",
                        display: "flex",
                        flexDirection: "column",
                        alignItems: "center",
                        gap: "2px",
                  ...
                  >
                    ...
                    <polyline
                      points="50,50 260,65 470,80 680,95 900,110"
                      fill="none"
                      stroke="#0099A6"
                      strokeWidth="4"
                      strokeLinecap="round"
                    ...
                    {chartPoints.map((pt, i) => (
                      <circle
                        ...
                        cx={pt.x}
                        cy={pt.y}
                        r={hoveredPainPoint?.date === pt.date ? "7" : "5"}
                        fill="#0099A6"
                        stroke="white"
                        strokeWidth="2.5"
            ...
            >
              ...
              >
                ...
                <div style={{ color: "#7AAAB4", fontSize: "13px" }}>
                  Dr. Sarah K. — Occupational Therapy
                </div>
              </div>
            </div>
          </div>
              ...
              {!selectedSession ? (
                <>
                  ...
                  >
                    ...
                    >
                      {allSessionsData.length} sessions
                    </div>
                  </div>
                    ...
                    {allSessionsData.map((session) => (
                      <div
                        ...
                        style={{
                          ...
                          alignItems: "center",
                          gap: "24px",
                          boxShadow: "0px 2px 8px rgba(28, 24, 22, 0.03)",
                          cursor: "pointer",
                          transition: "transform 0.2s",
                          flexShrink: 0,
                        }}
